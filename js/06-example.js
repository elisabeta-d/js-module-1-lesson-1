/* 
   ...
   Weight and height are stored in the weight and height variables, but not as NumberConstructor, but in as strings (specially for the task).
   Non-integer numbers can be given as 24.7 or 24,7, that is, as a separator of the fractional part can be coma.
